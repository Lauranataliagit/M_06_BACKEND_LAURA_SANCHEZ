...
<head>
    ...
    <title>Edad Exacta</title><!--Se cambia titulo-->
</head>
    ...
    <div class="main-frame-cal">
        ...
        if (isset($_POST['verificar'])) {
            ...
            if ($edad_actual >= constante_18) {
                echo "<h2> Su edad es de " . $edad_actual . " años, por tanto: Es mayor de edad </h2>"; #Se cambia el string de los echos
            } else if ($edad_actual < constante_18 && $edad_actual > constante0) {
                echo "<h2> Su edad es " . $edad_actual . " años, por tanto: No es mayor de edad </h2>";
            } else {
